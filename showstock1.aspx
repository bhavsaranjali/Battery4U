    ...
    <form id="form1" runat="server">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:ConnectionString %>' SelectCommand="SELECT [Company], [Product_Name], [Model_No], [stock] FROM [stock] WHERE ([Dist_No] = @Dist_No AND [Company] = @com)" >
                    <SelectParameters>
