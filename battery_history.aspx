<%@ Page Language="C#" AutoEventWireup="true" Codefile="battery_history.aspx.cs" Inherits="webapp1.battery_history" %>
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <asp:GridView ID="GridView1" runat="server" BackColor="Transparent" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="5"  CellSpacing="5" ForeColor="Black" GridLines="Horizontal" DataSourceID="SqlDataSource1" AutoGenerateColumns="False">
                <Columns >
                  ...
                  <asp:BoundField DataField="Date" HeaderText="Date" SortExpression="Date"></asp:BoundField>
                    <asp:BoundField DataField="Number_Of_Batteries" HeaderText="Number_Of_Batteries" SortExpression="Number_Of_Batteries"></asp:BoundField>
                </Columns>
            ...
            <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:ConnectionString %>' SelectCommand="SELECT [Dist_No], [Dist_Name], [Company_Name], [Product_name], [Model_No], [Category], [Price], [Warranty], [Capacity], [Date], [Number_Of_Batteries] FROM [PurchaseHistory] WHERE ([User_No] = @User_No)">
                <SelectParameters>
