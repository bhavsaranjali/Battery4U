    ...
    <form id="form1" runat="server">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:ConnectionString %>' SelectCommand="SELECT [User_No], [User_Name], [Company_Name], [Product_name], [Model_No], [Category], [Price], [Warranty], [Capacity], [Date], [Number_Of_Batteries] FROM [PurchaseHistory] WHERE ([Dist_No] = @Dist_No)">
                    <SelectParameters>
